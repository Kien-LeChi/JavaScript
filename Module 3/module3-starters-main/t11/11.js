...
//picArray : Array of articles objects
...
const q = document.querySelector("#pictures")
for (let article of picArray) {
    ...
    figcaption.innerText = article.caption;

    //figure img and figcaption sits inside figure
